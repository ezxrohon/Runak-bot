...
from .grouplog import register_grouplog_handlers
...
from .cardgame import register_cardgame_handlers
...
def register_all_handlers(app):
    ...
    register_cardgame_handlers(app)
