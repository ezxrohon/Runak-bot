...
TIER_PRIVILEGES = {
    1: ChatPrivileges(
        ...
        can_restrict_members=False,   # no ban/mute right for Junior Admin
        can_promote_members=False,    # no add-admin right for Junior Admin
    ...
    2: ChatPrivileges(
        ...
        can_delete_messages=True,
        can_manage_video_chats=False,
        can_restrict_members=True,    # ban/mute right
        can_promote_members=True,     # add-admin right
        can_change_info=False,
        can_invite_users=True,
